...
class GooglePlaceSearchTool:
    ...
    def google_search_restraunts(self,place:str)->str:
        """
        Searches for available restaurants in the specified place using GooglePlaces API.
        """
        return self.places_tool.run(f"what are the top 10 veg and non veg restaurants and eateries in and around {place}?")
    ...
    def google_search_transportation(self, place: str) -> dict:
        ...
        """
        return self.places_tool.run(f"What are the different modes of transportations available in or around {place} to use")
...
class TavilyPlaceSearchTool:
    ...
    def tavily_search_restraunts(self,place:str)->dict:
        ...
        tavily_tool=TavilySearch(
            topic="general" , include_answer="advanced"
        )
        
        result=tavily_tool.invoke({
            "query":f"what are the top 10 veg and non veg restaurants and eateries in and around {place}."
        })
    ...
    def tavily_search_activities(self,place:str)->dict:
        ...
        result=tavily_tool.invoke({
            "query":f"What are some popular activites to do in or around {place}"
        })
